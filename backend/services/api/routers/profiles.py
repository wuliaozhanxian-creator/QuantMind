...
from backend.services.api.user_app.services import ProfileService
...
def _filter_sensitive_profile_data(data: dict, current_user: dict, target_user_id: str) -> dict:
    ...
    # 2. 用户访问自己的档案
    is_internal = current_user.get("username") == "internal"
