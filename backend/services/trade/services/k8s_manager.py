...
class K8sManager:
    ...
    def __init__(self):
        ...
        self.mode = (
            "docker" if os.getenv("DOCKER_MODE", "false").lower() == "true" else "k8s"
        )
        self.api = None
        self.core_api = None
    ...
    def _init_docker(self):
        ...
        try:
            if docker:
                ...
                logger.error(
                    "Docker SDK (docker-py) not installed, but DOCKER_MODE=true"
                )
                self.api = None
                self.core_api = None
    ...
    def _init_k8s(self):
        ...
        try:
            ...
            self.namespace = (
                str(os.getenv("K8S_NAMESPACE", "quantmind")).strip() or "quantmind"
            )
        except Exception as e:
    ...
    def _create_k8s_deployment(
        ...
        container = client.V1Container(
            ...
            env=[
                ...
                client.V1EnvVar(
                    name="COS_BUCKET_URL",
                    value=os.getenv("COS_BUCKET_URL", "https://cos.quantmind.cloud"),
                ),
            ],
        )
